...
const steps: Step[] = [
  {
    ...
    label: "Upload PDF",
    description: "Simply drag and drop your PDF file and click on the upload",
  },
  {
    icon: <BrainCircuit size={64} strokeWidth={1.5} />,
    label: "AI Analysis",
    description:
      "Our advanced AI analyzes the content and extracts the most important information",
  },
  {
    icon: <FileOutput size={64} strokeWidth={1.5} />,
    label: "Get Summary",
    description: "Receive a concise summary of the PDF content in seconds",
  },
];
      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        <div className="text-center mb-16">
          <MotionH2
            ...
            className="text-xl uppercase font-bold mb-4 text-rose-500"
          >
            How It Works
          </MotionH2>
          <MotionH3
            ...
            className="font-bold text-3xl max-w-2xl mx-auto text-slate-700"
          >
            Transform your PDFs into easily readable summaries in three simple
            steps
          </MotionH3>
        </div>
            ...
            >
              ...
              {idx < steps.length - 1 && (
                <MotionDiv
                  ...
                  transition={{ duration: 0.5, delay: idx * 0.2 }}
                  className="hidden md:block absolute top-1/2 -right-4 transform -translate-1/2 z-10"
                >
                  <MoveRight
                    size={32}
                    strokeWidth={1}
    ...
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border border-white/10 hover:border-rose-500/50 transition-colors group w-full">
      <div className="flex flex-col gap-4 h-full">
        ...
        <div className="flex flex-col flex-1 gap-1 justify-between">
          <h4 className="text-center text-slate-700 font-bold text-xl">
            {label}
          </h4>
